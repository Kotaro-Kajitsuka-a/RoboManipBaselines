...
# This name is intentionally unique to the Gaussian PB comparison study.
dataset_dir=robo_manip_baselines/dataset/DatasetMujocoUR5eLiftingi_EefPose_ConstantPB_GaussianStudy_20260821_v1
...
echo "constant PB checkpoints: ${checkpoint_prefix}_seed{42,52,62}"
