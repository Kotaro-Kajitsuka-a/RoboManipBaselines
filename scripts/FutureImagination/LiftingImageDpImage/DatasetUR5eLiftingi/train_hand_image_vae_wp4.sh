...
vae_output_dir=robo_manip_baselines/checkpoint/ImageVAE/DatasetMujocoUR5eLiftingi_hand_9
wp4_checkpoint_dir=robo_manip_baselines/checkpoint/WrenchPredictor4/DatasetMujocoUR5eLiftingi_hand_image_vae_9
