...
for train_seed in 42 52 62; do
  (
  dp_checkpoint="robo_manip_baselines/checkpoint/DiffusionPolicy/DpImageLeft/DatasetMujocoUR5eLiftingi_LeftScratchVAE9_OnlinePB_seed${train_seed}/policy_last.ckpt"
  ...
  for object_id in 0 1 2 4 5 6 7; do
    ...
    find robo_manip_baselines/dataset \
      ...
      -maxdepth 1 \
      -type d \
      -name "RolloutDiffusionPolicyOnlinePb_MujocoUR5eLiftingi_I${object_id}_left_scratch_vae9_online_pb_trainseed${train_seed}_20*" \
