...
eval_dir="robo_manip_baselines/dataset/tests/FutureImagination/LiftingImageAB_B_only/DpImage_constant_pb_eval_${eval_timestamp}"
...
for train_seed in 42 52 62; do
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --checkpoint "robo_manip_baselines/checkpoint/DiffusionPolicy/DpImageLeft/LiftingImageAB_B_only_ConstantPB_seed${train_seed}/policy_last.ckpt" \
