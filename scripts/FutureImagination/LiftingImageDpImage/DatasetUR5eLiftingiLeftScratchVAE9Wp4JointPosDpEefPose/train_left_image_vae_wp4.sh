...
# Train the left-camera ImageVAE 9D and joint-position WP4 on the new dataset.
...
vae_output_dir=robo_manip_baselines/checkpoint/ImageVAE/DatasetMujocoUR5eLiftingi_left_9
wp4_checkpoint_dir=robo_manip_baselines/checkpoint/WrenchPredictor4/DatasetMujocoUR5eLiftingi_left_image_vae_9_joint_pos
