...
eval_dir="robo_manip_baselines/dataset/tests/FutureImagination/DatasetMujocoUR5eLiftingi_LeftScratchVAE9_Wp4JointPos_DpEefPose/DpImage_constant_pb_lr3e3_eval_${eval_timestamp}"
...
for train_seed in 42 52 62; do
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "DpImage_MujocoUR5eLiftingi_I0_left_scratch_vae9_wp4_joint_dp_eef_constant_pb_lr3e3_trainseed${train_seed}" \
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "DpImage_MujocoUR5eLiftingi_I1_left_scratch_vae9_wp4_joint_dp_eef_constant_pb_lr3e3_trainseed${train_seed}" \
    --checkpoint "$dp_checkpoint" \
    --wp4_checkpoint "$wp4_checkpoint" \
    --image_vae_checkpoint "$image_vae_checkpoint" \
    --image_vae_camera_name left \
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "DpImage_MujocoUR5eLiftingi_I2_left_scratch_vae9_wp4_joint_dp_eef_constant_pb_lr3e3_trainseed${train_seed}" \
    --checkpoint "$dp_checkpoint" \
    --wp4_checkpoint "$wp4_checkpoint" \
    --image_vae_checkpoint "$image_vae_checkpoint" \
    --image_vae_camera_name left \
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "DpImage_MujocoUR5eLiftingi_I4_left_scratch_vae9_wp4_joint_dp_eef_constant_pb_lr3e3_trainseed${train_seed}" \
    --checkpoint "$dp_checkpoint" \
    --wp4_checkpoint "$wp4_checkpoint" \
    --image_vae_checkpoint "$image_vae_checkpoint" \
    --image_vae_camera_name left \
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "DpImage_MujocoUR5eLiftingi_I5_left_scratch_vae9_wp4_joint_dp_eef_constant_pb_lr3e3_trainseed${train_seed}" \
    --checkpoint "$dp_checkpoint" \
    --wp4_checkpoint "$wp4_checkpoint" \
    --image_vae_checkpoint "$image_vae_checkpoint" \
    --image_vae_camera_name left \
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "DpImage_MujocoUR5eLiftingi_I6_left_scratch_vae9_wp4_joint_dp_eef_constant_pb_lr3e3_trainseed${train_seed}" \
    --checkpoint "$dp_checkpoint" \
    --wp4_checkpoint "$wp4_checkpoint" \
    --image_vae_checkpoint "$image_vae_checkpoint" \
    --image_vae_camera_name left \
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "DpImage_MujocoUR5eLiftingi_I7_left_scratch_vae9_wp4_joint_dp_eef_constant_pb_lr3e3_trainseed${train_seed}" \
    --checkpoint "$dp_checkpoint" \
    --wp4_checkpoint "$wp4_checkpoint" \
    --image_vae_checkpoint "$image_vae_checkpoint" \
    --image_vae_camera_name left \
  ...
  for object_id in 0 1 2 4 5 6 7; do
    ...
    find robo_manip_baselines/dataset \
      ...
      -maxdepth 1 \
      -type d \
      -name "RolloutDiffusionPolicyOnlinePb_DpImage_MujocoUR5eLiftingi_I${object_id}_left_scratch_vae9_wp4_joint_dp_eef_constant_pb_lr3e3_trainseed${train_seed}_20*" \
