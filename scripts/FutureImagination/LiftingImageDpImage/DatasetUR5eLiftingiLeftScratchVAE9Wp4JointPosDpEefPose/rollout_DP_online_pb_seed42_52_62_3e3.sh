...
for train_seed in 42 52 62; do
  (
  dp_checkpoint="robo_manip_baselines/checkpoint/DiffusionPolicy/DatasetMujocoUR5eLiftingi_LeftScratchVAE9_Wp4JointPos_DpEefPose_AdamOnlinePB_lr3e3_seed${train_seed}/policy_last.ckpt"
