...
eval_dir="robo_manip_baselines/dataset/tests/FutureImagination/LiftingAB_B_only_LeftScratchVAE9_Wp4JointPos_DpEefPose/DP_online_pb_adam_eval_${eval_timestamp}"
...
for train_seed in 42 52 62; do
  (
  dp_checkpoint="robo_manip_baselines/checkpoint/DiffusionPolicy/LiftingAB_B_only_LeftScratchVAE9_Wp4JointPos_DpEefPose_AdamOnlinePB_seed${train_seed}/policy_last.ckpt"
