...
eval_dir="robo_manip_baselines/dataset/tests/FutureImagination/AdmittancePushTFast/DP_online_pb_eval_${eval_timestamp}"
...
for train_seed in 42 52 62; do
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "AdmittancePushTFastOnline_trainseed${train_seed}_rollseed42_T0" \
    --checkpoint "robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushTFast/online_seed${train_seed}/policy_last.ckpt" \
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "AdmittancePushTFastOnline_trainseed${train_seed}_rollseed42_T1" \
    --checkpoint "robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushTFast/online_seed${train_seed}/policy_last.ckpt" \
    --wp4_checkpoint "$wp4_checkpoint" \
    --initial_object_id 0 \
    --online_pb_lr 2.5e-2 \
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "AdmittancePushTFastOnline_trainseed${train_seed}_rollseed42_T2" \
    --checkpoint "robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushTFast/online_seed${train_seed}/policy_last.ckpt" \
    --wp4_checkpoint "$wp4_checkpoint" \
    --initial_object_id 0 \
    --online_pb_lr 2.5e-2 \
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "AdmittancePushTFastOnline_trainseed${train_seed}_rollseed42_T3" \
    --checkpoint "robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushTFast/online_seed${train_seed}/policy_last.ckpt" \
    --wp4_checkpoint "$wp4_checkpoint" \
    --initial_object_id 0 \
    --online_pb_lr 2.5e-2 \
  ...
  for object_id in 0 1 2 3; do
    ...
    find robo_manip_baselines/dataset \
      ...
      -maxdepth 1 \
      -type d \
      -name "RolloutDiffusionPolicyOnlinePb_AdmittancePushTFastOnline_trainseed${train_seed}_rollseed42_T${object_id}_20*" \
