...
for train_seed in 42 52 62; do
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "AdmittancePushTFastBaseline_trainseed${train_seed}_rollseed42_T0" \
    --checkpoint "robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushTFast/baseline_seed${train_seed}/policy_last.ckpt" \
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "AdmittancePushTFastBaseline_trainseed${train_seed}_rollseed42_T1" \
    --checkpoint "robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushTFast/baseline_seed${train_seed}/policy_last.ckpt" \
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "AdmittancePushTFastBaseline_trainseed${train_seed}_rollseed42_T2" \
    --checkpoint "robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushTFast/baseline_seed${train_seed}/policy_last.ckpt" \
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --demo_name "AdmittancePushTFastBaseline_trainseed${train_seed}_rollseed42_T3" \
    --checkpoint "robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushTFast/baseline_seed${train_seed}/policy_last.ckpt" \
  ...
  for object_id in 0 1 2 3; do
    ...
    find robo_manip_baselines/dataset \
      ...
      -maxdepth 1 \
      -type d \
      -name "RolloutDiffusionPolicy_AdmittancePushTFastBaseline_trainseed${train_seed}_rollseed42_T${object_id}_20*" \
