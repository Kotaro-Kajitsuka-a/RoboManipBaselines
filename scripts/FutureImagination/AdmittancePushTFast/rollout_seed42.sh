...
baseline_checkpoint=robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushTFast/baseline_seed42/policy_last.ckpt
online_checkpoint=robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushTFast/online_seed42/policy_last.ckpt
constant_checkpoint=robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushTFast/constant_seed42/policy_last.ckpt
wp4_checkpoint=robo_manip_baselines/checkpoint/WrenchPredictor4/AdmittancePushTFast/policy_best.ckpt
eval_dir=robo_manip_baselines/dataset/tests/FutureImagination/AdmittancePushTFast/save_rollout_seed42
...
python robo_manip_baselines/bin/Rollout.py DiffusionPolicy MujocoXarm7AdmittancePusht_T0 \
  --demo_name AdmittancePushTFastBaseline_seed42_T0 \
...
python robo_manip_baselines/bin/Rollout.py DiffusionPolicy MujocoXarm7AdmittancePusht_T1 \
  --demo_name AdmittancePushTFastBaseline_seed42_T1 \
  --checkpoint "$baseline_checkpoint" \
...
python robo_manip_baselines/bin/Rollout.py DiffusionPolicy MujocoXarm7AdmittancePusht_T2 \
  --demo_name AdmittancePushTFastBaseline_seed42_T2 \
  --checkpoint "$baseline_checkpoint" \
...
python robo_manip_baselines/bin/Rollout.py DiffusionPolicy MujocoXarm7AdmittancePusht_T3 \
  --demo_name AdmittancePushTFastBaseline_seed42_T3 \
  --checkpoint "$baseline_checkpoint" \
...
python robo_manip_baselines/bin/Rollout.py DiffusionPolicyOnlinePb MujocoXarm7AdmittancePusht_T0 \
  --demo_name AdmittancePushTFastOnline_seed42_T0 \
...
python robo_manip_baselines/bin/Rollout.py DiffusionPolicyOnlinePb MujocoXarm7AdmittancePusht_T1 \
  --demo_name AdmittancePushTFastOnline_seed42_T1 \
  --checkpoint "$online_checkpoint" \
  --wp4_checkpoint "$wp4_checkpoint" \
  --initial_object_id 0 \
  --online_pb_lr 2.5e-2 \
...
python robo_manip_baselines/bin/Rollout.py DiffusionPolicyOnlinePb MujocoXarm7AdmittancePusht_T2 \
  --demo_name AdmittancePushTFastOnline_seed42_T2 \
  --checkpoint "$online_checkpoint" \
  --wp4_checkpoint "$wp4_checkpoint" \
  --initial_object_id 0 \
  --online_pb_lr 2.5e-2 \
...
python robo_manip_baselines/bin/Rollout.py DiffusionPolicyOnlinePb MujocoXarm7AdmittancePusht_T3 \
  --demo_name AdmittancePushTFastOnline_seed42_T3 \
  --checkpoint "$online_checkpoint" \
  --wp4_checkpoint "$wp4_checkpoint" \
  --initial_object_id 0 \
  --online_pb_lr 2.5e-2 \
...
python robo_manip_baselines/bin/Rollout.py DiffusionPolicyOnlinePb MujocoXarm7AdmittancePusht_T0 \
  --demo_name AdmittancePushTFastConstant_seed42_T0 \
...
python robo_manip_baselines/bin/Rollout.py DiffusionPolicyOnlinePb MujocoXarm7AdmittancePusht_T1 \
  --demo_name AdmittancePushTFastConstant_seed42_T1 \
  --checkpoint "$constant_checkpoint" \
  --wp4_checkpoint "$wp4_checkpoint" \
  --initial_object_id 0 \
  --online_pb_lr 2.5e-2 \
...
python robo_manip_baselines/bin/Rollout.py DiffusionPolicyOnlinePb MujocoXarm7AdmittancePusht_T2 \
  --demo_name AdmittancePushTFastConstant_seed42_T2 \
  --checkpoint "$constant_checkpoint" \
  --wp4_checkpoint "$wp4_checkpoint" \
  --initial_object_id 0 \
  --online_pb_lr 2.5e-2 \
...
python robo_manip_baselines/bin/Rollout.py DiffusionPolicyOnlinePb MujocoXarm7AdmittancePusht_T3 \
  --demo_name AdmittancePushTFastConstant_seed42_T3 \
  --checkpoint "$constant_checkpoint" \
  --wp4_checkpoint "$wp4_checkpoint" \
  --initial_object_id 0 \
  --online_pb_lr 2.5e-2 \
...
find robo_manip_baselines/dataset \
  ...
  -type d \
  \( \
    -name "RolloutDiffusionPolicy_AdmittancePushTFastBaseline_seed42_T[0-3]_20*" \
    -o -name "RolloutDiffusionPolicyOnlinePb_AdmittancePushTFastOnline_seed42_T[0-3]_20*" \
    -o -name "RolloutDiffusionPolicyOnlinePb_AdmittancePushTFastConstant_seed42_T[0-3]_20*" \
  \) \
