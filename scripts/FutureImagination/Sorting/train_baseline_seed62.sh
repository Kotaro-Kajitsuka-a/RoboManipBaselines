...
# Train front-image Diffusion Policy without PB input using seed 62.
dataset_dir=robo_manip_baselines/dataset/0826_DatasetSorting/training
checkpoint_dir=robo_manip_baselines/checkpoint/DiffusionPolicy/DpImageFront/0826_DatasetSorting_EefPose_Baseline_seed62
