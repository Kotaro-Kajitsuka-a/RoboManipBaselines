...
# Train with each episode's learned constant PB using seed 52.
dataset_dir=robo_manip_baselines/dataset/0826_DatasetSorting_FrontLarge3Z16_Wp4JointPos_ConstantPB/training
checkpoint_dir=robo_manip_baselines/checkpoint/DiffusionPolicy/DpImageFront/0826_DatasetSorting_FrontLarge3Z16_Wp4JointPos_EefPose_ConstantPB_seed52
