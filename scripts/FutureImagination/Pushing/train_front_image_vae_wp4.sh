...
vae_output_dir=robo_manip_baselines/checkpoint/ImageVAE/DatasetPushingPlaying_front_9
wp4_checkpoint_dir=robo_manip_baselines/checkpoint/WrenchPredictor4/DatasetPushingPlaying_front_image_vae_9_joint_pos
