...
# Train the default scratch VAE 9D and joint-position WP4 from front images.
train_dataset_dir=robo_manip_baselines/dataset/DatasetPushingLine/training
validation_dataset_dir=robo_manip_baselines/dataset/DatasetPushingLine/validation
vae_output_dir=robo_manip_baselines/checkpoint/ImageVAE/DatasetPushingLine_front_9
wp4_checkpoint_dir=robo_manip_baselines/checkpoint/WrenchPredictor4/DatasetPushingLine_front_image_vae_9_joint_pos
