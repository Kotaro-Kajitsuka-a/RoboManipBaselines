...
python robo_manip_baselines/bin/Train.py WrenchPredictor4 \
  --dataset_dir robo_manip_baselines/dataset/DatasetMujocoXarm7AdmittancePushtOracle/training \
  --val_dataset_dir robo_manip_baselines/dataset/DatasetMujocoXarm7AdmittancePushtValidation/validation \
  --checkpoint_dir robo_manip_baselines/checkpoint/WrenchPredictor4/AdmittancePushTOracle \
  --camera_names \
...
source_dataset=robo_manip_baselines/dataset/DatasetMujocoXarm7AdmittancePushtOracle
online_dataset=robo_manip_baselines/dataset/DatasetMujocoXarm7AdmittancePushtOracle_online_pb2
constant_dataset=robo_manip_baselines/dataset/DatasetMujocoXarm7AdmittancePushtOracle_constant_pb2
