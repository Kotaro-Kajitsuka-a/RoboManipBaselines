...
# Train the reproducible BetaVAE 9D with beta=1.5 and joint-position WP4.
...
vae_output_dir=robo_manip_baselines/checkpoint/ImageVAE/0827_DatasetPouch_right_9_beta1_5
wp4_checkpoint_dir=robo_manip_baselines/checkpoint/WrenchPredictor4/0827_DatasetPouch_right_image_vae_9_beta1_5_joint_pos
