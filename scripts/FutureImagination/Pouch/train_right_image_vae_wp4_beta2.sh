...
vae_output_dir=robo_manip_baselines/checkpoint/ImageVAE/0827_DatasetPouch_right_9_beta2
wp4_checkpoint_dir=robo_manip_baselines/checkpoint/WrenchPredictor4/0827_DatasetPouch_right_image_vae_9_beta2_joint_pos
