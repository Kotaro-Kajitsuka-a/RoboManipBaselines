...
python robo_manip_baselines/bin/Train.py WrenchPredictor4 \
  ...
  --checkpoint_dir robo_manip_baselines/checkpoint/WrenchPredictor4/DatasetMujocoUR5eLiftingi_EefPose \
  --camera_names \
...
python robo_manip_baselines/policy/wrench_predictor4/EvalWrenchPredictor4SweepDir.py \
  robo_manip_baselines/checkpoint/WrenchPredictor4/DatasetMujocoUR5eLiftingi_EefPose/policy_best.ckpt \
