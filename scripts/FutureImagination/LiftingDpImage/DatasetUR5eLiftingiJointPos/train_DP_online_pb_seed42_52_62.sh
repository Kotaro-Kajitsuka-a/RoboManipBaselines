...
python robo_manip_baselines/bin/Train.py DiffusionPolicy \
  ...
  --checkpoint_dir robo_manip_baselines/checkpoint/DiffusionPolicy/DatasetMujocoUR5eLiftingi_JointPos_Online_seed42 \
   --camera_names left \
    --scheduler ddim \
...
python robo_manip_baselines/bin/Train.py DiffusionPolicy \
  --dataset_dir robo_manip_baselines/dataset/DatasetMujocoUR5eLiftingi_JointPos_OnlinePB \
  --checkpoint_dir robo_manip_baselines/checkpoint/DiffusionPolicy/DatasetMujocoUR5eLiftingi_JointPos_Online_seed52 \
   --camera_names left \
    --scheduler ddim \
  --state_keys measured_joint_pos measured_tblock_pose material_property \
  --action_keys command_joint_pos \
...
python robo_manip_baselines/bin/Train.py DiffusionPolicy \
  --dataset_dir robo_manip_baselines/dataset/DatasetMujocoUR5eLiftingi_JointPos_OnlinePB \
  --checkpoint_dir robo_manip_baselines/checkpoint/DiffusionPolicy/DatasetMujocoUR5eLiftingi_JointPos_Online_seed62 \
   --camera_names left \
    --scheduler ddim \
  --state_keys measured_joint_pos measured_tblock_pose material_property \
  --action_keys command_joint_pos \
