...
# Reuse the existing Left VAE, JointPos WP4, PB-labeled datasets,
# and EEF-pose no-PB baseline.
...
test -d robo_manip_baselines/dataset/DatasetMujocoUR5eLiftingi_LeftScratchVAE9_OnlinePB
test -d robo_manip_baselines/dataset/DatasetMujocoUR5eLiftingi_LeftScratchVAE9_ConstantPB
