...
# Train a large3-z16 left-camera VAE and joint-position WP4.
...
vae_output_dir=robo_manip_baselines/checkpoint/ImageVAE/DatasetMujocoUR5eLiftingi_left_large3_z16
wp4_checkpoint_dir=robo_manip_baselines/checkpoint/WrenchPredictor4/DatasetMujocoUR5eLiftingi_left_image_vae_large3_z16_joint_pos
...
# WP4 reads image_vae_left_16 and does not consume a raw camera stream.
python robo_manip_baselines/bin/Train.py WrenchPredictor4 \
  ...
  --image_feature_key image_vae_left_16 \
