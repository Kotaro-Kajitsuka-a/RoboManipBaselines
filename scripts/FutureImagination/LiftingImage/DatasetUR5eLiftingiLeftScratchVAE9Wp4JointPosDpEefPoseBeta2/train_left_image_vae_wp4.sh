...
# Train the left-camera BetaVAE 9D with beta=2.0 and joint-position WP4.
...
vae_output_dir=robo_manip_baselines/checkpoint/ImageVAE/DatasetMujocoUR5eLiftingi_left_9_beta2
wp4_checkpoint_dir=robo_manip_baselines/checkpoint/WrenchPredictor4/DatasetMujocoUR5eLiftingi_left_image_vae_9_beta2_joint_pos
