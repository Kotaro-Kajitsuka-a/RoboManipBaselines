...
dataset_dir=robo_manip_baselines/dataset/DatasetMujocoUR5eLiftingi_LeftScratchVAE9Beta2_Wp4JointPos_DpEefPose_AdamOnlinePB
checkpoint_prefix=robo_manip_baselines/checkpoint/DiffusionPolicy/DatasetMujocoUR5eLiftingi_LeftScratchVAE9Beta2_Wp4JointPos_DpEefPose_AdamOnlinePB
