...
eval_dir="robo_manip_baselines/dataset/tests/FutureImagination/DatasetMujocoUR5eLiftingi_Image/DP_eef_pose_baseline_eval_${eval_timestamp}"
...
for train_seed in 42 52 62; do
  ...
  for object_id in 0 1 2 4 5 6 7; do
    ...
    find robo_manip_baselines/dataset \
      ...
      -maxdepth 1 \
      -type d \
      -name "RolloutDiffusionPolicy_MujocoUR5eLiftingi_I${object_id}_eef_pose_baseline_trainseed${train_seed}_20*" \
