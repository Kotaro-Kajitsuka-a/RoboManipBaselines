...
eval_dir="robo_manip_baselines/dataset/tests/FutureImagination/AdmittancePushT/DP_baseline_eval_${eval_timestamp}"
...
for train_seed in 42 52 62; do
  ...
  python robo_manip_baselines/bin/Rollout.py \
    ...
    --checkpoint "robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushT/baseline_seed${train_seed}/policy_last.ckpt" \
