...
python robo_manip_baselines/bin/Train.py DiffusionPolicy \
  ...
  --checkpoint_dir robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushT/baseline_seed42 \
  --camera_names \
...
python robo_manip_baselines/bin/Train.py DiffusionPolicy \
  ...
  --checkpoint_dir robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushT/online_seed42 \
  --camera_names \
...
python robo_manip_baselines/bin/Train.py DiffusionPolicy \
  ...
  --checkpoint_dir robo_manip_baselines/checkpoint/DiffusionPolicy/AdmittancePushT/constant_seed42 \
  --camera_names \
  --state_keys measured_eef_pose measured_tblock_pose material_property \
  --action_keys command_eef_pose \
  --train_ratio 1.0 \
