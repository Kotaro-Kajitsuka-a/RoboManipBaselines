...
eval_dir="robo_manip_baselines/dataset/tests/FutureImagination/AdmittancePushT/DP_constant_pb_eval_${eval_timestamp}"
...
for train_seed in 42 52 62; do
  ...
  for object_id in 0 1 2 3; do
    ...
    find robo_manip_baselines/dataset \
      ...
      -maxdepth 1 \
      -type d \
      -name "RolloutDiffusionPolicyOnlinePb_AdmittancePushTConstant_trainseed${train_seed}_rollseed42_T${object_id}_20*" \
