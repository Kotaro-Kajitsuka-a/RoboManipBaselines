...
if __name__ == "__main__":
    # 例
    left_file = "robo_manip_baselines/calib/base_left_T_top.calib"
    right_file = "robo_manip_baselines/calib/base_right_T_top.calib"
    ...
    output_path = "robo_manip_baselines/calib/base_center_T_top.calib"
