...
register(
    id="robo_manip_baselines/MujocoXarm7Pusht1Env-v0",
    entry_point="robo_manip_baselines.envs.mujoco:MujocoXarm7Pusht1Env",
)
register(
    id="robo_manip_baselines/MujocoXarm7Pusht2Env-v0",
    entry_point="robo_manip_baselines.envs.mujoco:MujocoXarm7Pusht2Env",
)
register(
    id="robo_manip_baselines/MujocoXarm7Pusht3Env-v0",
...
register(
    id="robo_manip_baselines/MujocoXarm7AdmittancePusht1Env-v0",
    entry_point="robo_manip_baselines.envs.mujoco:MujocoXarm7AdmittancePusht1Env",
)
register(
    id="robo_manip_baselines/MujocoXarm7AdmittancePusht2Env-v0",
    entry_point="robo_manip_baselines.envs.mujoco:MujocoXarm7AdmittancePusht2Env",
)
register(
    id="robo_manip_baselines/MujocoXarm7AdmittancePusht3Env-v0",
    entry_point="robo_manip_baselines.envs.mujoco:MujocoXarm7AdmittancePusht3Env",
)
register(
    id="robo_manip_baselines/MujocoXarm7AdmittancePusht_T0Env-v0",
    entry_point="robo_manip_baselines.envs.mujoco:MujocoXarm7AdmittancePusht_T0Env",
)
register(
    id="robo_manip_baselines/MujocoXarm7AdmittancePusht_T1Env-v0",
    entry_point="robo_manip_baselines.envs.mujoco:MujocoXarm7AdmittancePusht_T1Env",
)
register(
    id="robo_manip_baselines/MujocoXarm7AdmittancePusht_T2Env-v0",
    entry_point="robo_manip_baselines.envs.mujoco:MujocoXarm7AdmittancePusht_T2Env",
)
register(
    id="robo_manip_baselines/MujocoXarm7AdmittancePusht_T3Env-v0",
    entry_point="robo_manip_baselines.envs.mujoco:MujocoXarm7AdmittancePusht_T3Env",
)
register(
...
register(
    id="robo_manip_baselines/MujocoXarm7DualAdmittanceBoxEnv-v0",
    entry_point="robo_manip_baselines.envs.mujoco:MujocoXarm7DualAdmittanceBoxEnv",
)
